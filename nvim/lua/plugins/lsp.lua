return {
  ...
  config = function()
    ...
    require "NoeszcConfig.diagnostic"

    local group = vim.api.nvim_create_augroup("NoeszcConfigLSP", { clear = true })
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        map("gd", function() snacks.picker.lsp_definitions(picker_opts) end)
        map("gvd", function() 
          snacks.picker.lsp_definitions(vim.tbl_deep_extend("force", {}, picker_opts, {
            confirm = "edit_vsplit",
          }))
        end)
        map("grr", function() snacks.picker.lsp_references(picker_opts) end)
        map("gI", function() snacks.picker.lsp_implementations(picker_opts) end)
        map("<leader>D", function() snacks.picker.lsp_type_definitions(picker_opts) end)
